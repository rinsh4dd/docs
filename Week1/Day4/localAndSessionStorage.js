...
Here it can be seen that till we are inserting data in the form of string or number, 
we are able to get data correcrly! In the second last attempt we are going to inserting a plain object into key geek and when we get that item it return [object, object]
 */
...
LocalStorage.setItem("geek", JSON.stringify({
// "key":"value"
}))
undefined
